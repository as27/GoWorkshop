...
var f4 = &Field{
	Values: [][]int{
		[]int{0, 1, 0, 0, 2, 8, 6, 0, 0},
		[]int{0, 0, 0, 0, 3, 0, 7, 0, 0},
		[]int{5, 3, 8, 0, 0, 0, 0, 0, 0},
		[]int{4, 0, 2, 0, 0, 0, 0, 0, 0},
		[]int{3, 0, 0, 0, 8, 0, 0, 0, 9},
		[]int{0, 0, 0, 9, 6, 0, 0, 4, 0},
		[]int{0, 0, 0, 0, 0, 7, 2, 0, 0},
		[]int{2, 0, 5, 3, 0, 0, 0, 0, 0},
		[]int{0, 0, 0, 0, 0, 0, 9, 0, 1},
	},
}

func BenchmarkSolveF2(b *testing.B) {
	for i := 0; i < b.N; i++ {
		f2.Solve()
	}
}
func BenchmarkSolveF3(b *testing.B) {
	for i := 0; i < b.N; i++ {
		f3.Solve()
	}
}
